...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="club_writeAction.jsp">
						...
						<tr>
                            <td>
                                <div class="form-inline">
                                    ...
                                    <input type="text" class="form-control" placeholder="글 제목" name="club_boardTitle" maxlength="50" style ="width: 80%" >
                                </div>
                            </td>
                        </tr>
                        <tr>
							<td>
								<textarea class="form-control" class="TinyMCE" placeholder="글 내용" name="club_boardContent" maxlength="2048" style="height: 350px;"></textarea>
								<script>
								    function convertHtmlToText() {
								        ...
								        document.getElementById("club_boardContentText").value = textContent;
								    }
