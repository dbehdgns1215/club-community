...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="board.jsp">동아리 연합 활동</a></li>
			</ul>
			<%
				if (userID == null) {
			%>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="community_writeAction.jsp">
						...
						<tbody>
                            ...
                            <td>
                                <div class="form-inline">
                                    ...
                                    <input type="text" class="form-control" placeholder="글 제목" name="communityTitle" maxlength="50" style ="width: 80%" >
                                </div>
                            </td>
                        </tr>
                        <tr>
								<td>
									<textarea class="form-control" class="TinyMCE" placeholder="글 내용" name="communityContent" maxlength="2048" style="height: 350px;"></textarea>
										<script>
